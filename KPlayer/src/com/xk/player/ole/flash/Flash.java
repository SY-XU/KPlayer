package com.xk.player.ole.flash;
...
import com.xk.player.ole.OleContainer;
import com.xk.player.ole.OleObject;
...
public class Flash extends OleContainer
{
	...
	public Flash( Composite parent, int style, FlashEventListener listener )
	{
		...
		catch ( Throwable ex )
		{
			...
			errorLabel.setForeground( SWTResourceManager.getColor( 255,
					0,
					0 ) );
